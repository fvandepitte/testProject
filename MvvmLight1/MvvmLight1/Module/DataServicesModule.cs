...
{
    public class DataServicesModule : NinjectModule
    {
        public override void Load() {
            ...
            Bind<IDataService<DashboardWorkspaceItem>>().To<DashboardWorkspaceService>().WhenInjectedInto<DashboardWorkspaceViewModel>();
